<template>
    <div class="[ container ]">
     ...
     <h2>Privacy Policy</h2> <p>
                    Ibento built the Skjera? app as
                    a Free app. This SERVICE is provided by
                    Ibento at no cost and is intended for
                    use as is.
                  </p> <p>
                    ...
                    Skjera? unless otherwise defined in this Privacy
                    Policy.
                  </p> <p><strong>Information Collection and Use</strong></p> <p>
                    For a better experience, while using our Service,
                    we may require you to provide us with certain
                    personally identifiable information, including but not limited to List public events in an geographical area. The
